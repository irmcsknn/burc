import 'package:burc/giris/home_page.dart';
import 'package:burc/girisss.dart';
...
class __SignInBodyState extends State<_SignInBody> {
  ...
  _signInAnonymously() async{
    ...
    Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>girisss(),
    ));
  }
}
            ...
            children: [
              ...
              Container(
                ...
                child: SignInButton(Buttons.Email, text: "Email ile giriş yap",
                    onPressed: () async {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> girisss()),
                      );
